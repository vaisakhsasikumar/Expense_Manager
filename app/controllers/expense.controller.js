...
const ExpenseSchema = db.ExpenseSchema;
const buddySchema = db.buddySchema;
const newExpense = db.newExpenseSchema;
        ...
        ExpenseSchema.create(
            {
                ...
                "newExpense": {
                    ...
                    "totalBillAmount": 8844,
                    "splitAuto": true
                }
            }        ,{
            include:[{
                association: newExpense,buddies,
                include: [ newExpense.buddies ]
